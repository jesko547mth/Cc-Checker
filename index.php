...
<body onload="ccgen();  onLoadChks();"style="background: <?php echo $theme_background ?>;">
	<div class="container" id="container">
		...
		<!-- END OF FORMS -->
		<div class="footer" id="footer"><center><p style="color: <?php echo $theme_background ?>">Tikol4Life</p></center></div>
	</div>
				...
				<div class="modal-body" style="background: <?php echo $theme_background ?>">
					...
					<div name="howto" id="howto">
						<center >
							...
							<h6 style="color: <?php echo $theme_text ?>;">[1] Open our Telegram Bot: <a href="https://t.me/OfficialBinsBot" target="_blank">@OfficialBinsBot</a>.
